...
public class JmeRaceStartedEventPerfTestReferenceExtractor implements ReferenceExtractor<JmeRaceStartedEventReferences> {
    ...
    public Set<MessageData> getMessageData(JmeRaceStartedEventReferences references) {
        ...
        String controlPointCount = references.getWeatherAlertSubjectReference().getWeatherAlertSubject();
